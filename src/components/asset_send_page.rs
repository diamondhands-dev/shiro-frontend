...
pub fn asset_send_page(prop: &AssetSendPageInnerProp) -> Html {
    ...
    html! {
        ...
        <div class="container">
            <h3 style="text-align: center">{"Pay to"}</h3>
            <MatTextField outlined=true label="blinded UTXO" value="" oninput={oninput_pay_to}/>
            <h3 style="text-align: center">{"Amount to pay"}</h3>
            <MatTextField outlined=true label="0" value="" oninput={oninput_amount_to_pay}/>
            <h3 style="text-align: center">{"Fee rate in sat/vbyte"}</h3>
            <MatTextField outlined=true label="1.5" value="" oninput={oninput_fee_rate}/>
        </div>
        <div class="container">
            <div onclick={onclick}>
